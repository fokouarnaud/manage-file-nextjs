...
import "../../lib/Inter-Regular-normal";
  ...
  const handleGeneratePDF = () => {
   ...
   doc.setFont('Inter-Regular', 'normal');
    ...
    doc.autoTable({
      columns: [
        { dataKey: 'fr', header: '' },
        { dataKey: 'span_1', header: '' },
     
        { dataKey: 'span_2', header: '' },
        { dataKey: 'span_3', header: '' },
        { dataKey: 'en', header: '' }
       
       
      ],
      body: [
        {fr:'REPUBLIQUE DU CAMEROUN',en:'REPUBLIC OF CAMEROUN'},
      ...
      theme:'plain',
      tableHeight: 'wrap',
      styles: {font:"Inter-Regular",cellPadding: 0.5, fontSize: 8 },
